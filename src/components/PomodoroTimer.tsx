...
export default function PomodoroTimer({ task, onClose, onTimeUpdate }: PomodoroTimerProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black/70 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div className="bg-[#0a0a0a] border border-gray-800 rounded-2xl shadow-2xl max-w-lg w-full p-8 relative">
        {/* Close Button */}
        <button
          onClick={onClose}
        ...
        <div className="flex gap-4 mb-6">
          <button
            onClick={toggleTimer}
            className="flex-1 py-4 rounded-xl font-semibold bg-white text-black shadow-lg transition-all transform hover:scale-105 hover:bg-gray-100"
          >
            {isRunning ? (
          ...
          <button
            onClick={resetTimer}
            className="px-6 py-4 rounded-xl font-semibold bg-gray-900 text-gray-300 hover:bg-gray-800 transition-all border border-gray-800"
          >
